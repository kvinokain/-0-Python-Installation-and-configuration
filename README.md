...
# Критерии работы - https://disk.yandex.ru/d/0iSDLO2_P4zhvw  
Ознакомтесь с критериями. Оставьте их открытыми и проставляйте баллы в зависимости от того, что Вам удалось решить.
